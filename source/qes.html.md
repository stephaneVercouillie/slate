...
Please be aware that we support performing multiple signatures with 1 itsme® action, but this is an extra option called "batch signing". If you want to make use of it, be sure to mention it to the Onboarding team while setting up your project.
